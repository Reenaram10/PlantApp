...
MODEL_PATH = os.path.join(BASE_DIR, "plant_disease_detection", "model", "potato_disease_model.h5")
CLASSES_PATH = os.path.join(BASE_DIR, "plant_disease_detection", "model", "potato_indices.json")
FLOWER_DIR = os.path.join(BASE_DIR, "plant_disease_detection", "plant_disease_dataset", "Potato", "Flower")

print("--- Testing Potato Flower Model Predictions ---")
